...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-498%20passing-34A853" alt="498 tests">
...
```bash
.venv/bin/python -m pytest -q        # 498 passed, 8 deselected
.venv/bin/python -m pytest -m live   # the 8: real Gemini, real Grafana
```

506 collected, 498 offline, 8 marked `live`. ffmpeg must be on `PATH` — without it 85 tests error and 3 fail, which is the honest signal rather than a quiet skip.
